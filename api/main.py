...
from routers import health, ai, family_groups, parents, medications, session_notes, notifications, users, contact, auth_verification
...
app.include_router(auth_verification.router,   tags=["Auth"])
